...
model_name = 'PG_CFC_without_PG_weights'
...
model.summary()
model.compile(tf.keras.optimizers.Adam(learning_rate=0.00001),loss=mse_loss, metrics=[mae_loss])


history = model.fit(X,y,epochs=20,validation_split=0.2,callbacks=[loss_logger])
